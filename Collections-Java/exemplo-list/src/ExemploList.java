...
public class ExemploList {
  public static void main(String[] args) {
    ...
    System.out.println("Adicione na lista de notas a nota 8.0 na posição 4");
    notas.add(4, 8.0);
    System.out.println(notas);
    ...
    System.out.println("Exiba todas as notas na ordem em que foram informadas: " + notas);
    ...
    notas.add(3.6);
    // =========== Exercício ==============
    //Resolva esse exercício utilizando os métodos da implementação LinkedList
    
    System.out.println("Crie uma nova lista chamada notas2 e coloque todos os elementos " + 
